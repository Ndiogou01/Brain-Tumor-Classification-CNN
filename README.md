...
# À propos de moi:
Développeur Full-Stack Junior & Passionné d'IA basé à Saint-Louis, Sénégal. Actuellement en Master MIAGE à l'Université Gaston Berger.
Je me spécialise dans la création d'applications web évolutives et l'intégration de solutions de Machine Learning pour résoudre des problèmes concrets. De l'architecture backend avec Spring Boot et Symfony à la conception d'interfaces réactives avec Angular et React, j'aime faire le pont entre les données complexes et des expériences utilisateurs fluides.


## Réseaux:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/snsrt) 
...
---
[![](https://visitcount.itsvg.in/api?id=Ndiogou01&icon=10&color=0)](https://visitcount.itsvg.in)
